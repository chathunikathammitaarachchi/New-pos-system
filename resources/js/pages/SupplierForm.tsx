...
const SupplierForm: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.accNm.trim()) newErrors.accNm = 'Supplier Name is required';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Simulate API call
      const response = await fetch('http://localhost:8000/api/register/supplier', {
        method: 'POST',
        headers: {
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">Create a new supplier account</p>
        </div>
          ...
          <div onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  placeholder="Enter NIC or BR number"
                />
              </div>
            </div>
              ...
              <div className="mt-4">
                <label className="flex items-center">
                  ...
                  <span className="ml-2 text-sm font-medium text-gray-700">
                    This supplier is VAT registered
                  </span>
                </label>
              </div>
            </div>
            ...
            <div className="pt-6">
              <button
                ...
                disabled={loading}
                className="w-full bg-green-600 text-white py-3 px-6 rounded-lg font-medium hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition duration-200"
              >
                {loading ? (
